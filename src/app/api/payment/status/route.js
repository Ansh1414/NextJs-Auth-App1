...
export async function POST(NextRequest) {
  console.log('payment status route body outside--');
  ...
  const param1 =  NextRequest.nextUrl.searchParams.get('param1');
  const param2 =  NextRequest.nextUrl.searchParams.get('param2');
